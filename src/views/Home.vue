<template>
  <div class="w-full min-h-screen flex justify-start items-center flex-col gap-5 p-5  ">
    <div class="text-red-400 text-5xl font-bold font-K2D flex flex-col flex-nowrap gap-2 justify-center items-center sm:flex-row">
      ...
      <!-- <span>Pokédex</span> -->
      <img class="w-64" src="https://archives.bulbagarden.net/media/upload/4/4b/Pok%C3%A9dex_logo.png" alt="">
    </div>
